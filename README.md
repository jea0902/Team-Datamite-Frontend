...
### 서비스 기획 배경
- 현실에서 많은 사람들이 건강 상의 문제로 어떤 병원을 찾아야 하는지 혼란을 겪는 상황을 개선하고자 하는 의도에서 시작
- 증상이 발생하면 어떤 진료과에 해당하는지, 해당 진료과로 어떤 병원을 가야할지 등의 정보를 얻기 위해서는 여러 단계의 검색과 의사결정 과정이 필요 -> 이로 인해 환자들은 시간 낭비 등과 같은 불편을 경험하게 되며, 때로는 적절한 의료 서비스를 받지 못할 수도 있음
- 기존 대부분의 의료 정보 제공 서비스들은 비대면 진료와 병원 예약에 치중되어 있었고, 진료과 추천 서비스의 경우 반복적인 질문과 한계가 있는 선택지로 증상을 입력받음
