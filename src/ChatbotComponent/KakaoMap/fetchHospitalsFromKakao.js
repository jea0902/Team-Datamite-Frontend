...
export const fetchHospitalsFromKakao = async (query, lat, lon, radius = 3000) => {
    // 이 위에 있는 인자는 이 함수 내에서 사용되는 변수여야 함.
    const API_KEY = "71eb4c99656818b53b7557c13c716e16";
    ...
    while (page <= MAX_PAGES) {
        ...
        try {
            ...
            const filteredHospitals = response.data.documents.filter(hospital => !hospital.place_name.includes("코로나19"));
