...
function Signup() {
  ...
  function validateId() {
    ...
    if (id === "") {
      ...
      setIdError(
        "아이디는 5자~20자 영문으로 시작하며, 영문/ 숫자의 조합으로만 사용 가능합니다."
      );
      return false;
    } else {
      setIdError(""); // No error
  ...
  function validatePw() {
    if (password === "") {
      ...
      setPwError(
        "비밀번호는 8자~16자의 영문 대/소문자, 숫자, 특수문자를 사용해 주세요."
      );
      return false;
    } else {
      setPwError(""); // No error
          ...
          <form className="row" onSubmit={onSubmit}>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                name="name"
                id="name"
                className="form-control input-icon-placeholder3"
              />
              {nameError && (
                <div
                  style={{ color: "red", fontSize: "12px", marginTop: "5px" }}
            ...
            {/* 생년월일 */}
            <div className="mb-3">
              <label htmlFor="birthday8" className="form-label">
                생년월일
              </label>
              <input
                ...
                name="birthday8"
                id="birthday8"
                className="form-control input-icon-placeholder4"
              />
              {birthdayError && (
                <div
                  style={{ color: "red", fontSize: "12px", marginTop: "5px" }}
            ...
            >
              ...
              >
                <input
                  ...
                  id="btncheck1"
                  autoComplete="off"
                  checked={selected.btn1}
                  onChange={() => handleClick("btn1", "M")}
                />
                <label
                ...
                <input
                  ...
                  id="btncheck2"
                  autoComplete="off"
                  checked={selected.btn2}
                  onChange={() => handleClick("btn2", "F")}
                />
                <label
                  className="btn btn-outline-secondary"
                  htmlFor="btncheck2"
            ...
            <div className="mb-3">
              ...
              <div className="input-group">
                <input
                  ...
                  name="email"
                  id="email"
                  className="form-control input-icon-placeholder5"
                />
