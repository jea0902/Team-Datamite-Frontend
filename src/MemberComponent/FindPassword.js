  ...
  async function sendNumber() {
    try {
      const result = await axios.post(
        // 'http://localhost:8080/api/authenticate/email'
        "http://3.37.43.105:8080/api/authenticate/email",
        {
  ...
  async function onClick(event) {
    ...
    try {
      const result = await axios.post(
        ...
        "http://3.37.43.105:8080/api/auth/find/password",
        {
          id: id,
          name: name,
          birthDate: birthday8,
