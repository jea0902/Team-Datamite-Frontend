        ...
        <div className="container-lg">
            ...
            <div className="card w-50 mb-3 mx-auto align-items-center">
                <div className="card-body row w-100 text-center">
                    ...
                    <div class="card text-bg-light mb-3" style={{ maxwidth: '18rem', marginTop: '20px' }}>
                        <div class="card-body">
                            <h5 class="card-title">{String(id)}</h5>
                            {/* <p class="card-text">With supporting text below as a natural lead-in to additional content.</p> */}
                        </div>
                    </div>
                    <a href="#" class=" col-md-6 mb-3 btn btn-secondary">비밀번호 찾기</a>
                    <a href="#" class=" col-md-6 mb-3 btn btn-secondary">로그인</a>
                </div>
            </div >
        </div >
