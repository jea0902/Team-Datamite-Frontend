                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link" aria-current="page" href="/chat">챗봇</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="#">사진으로 물어보기</a>
                            </li>
                            <li className="nav-item">
                        ...
                        {isLogin ? (<div className="btn-group">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end">
                                <li><a className="dropdown-item" href="/mypage">My page</a></li>
                                {/* <li><a class="dropdown-item" href="#">Another action</a></li>
                                        <li><a class="dropdown-item" href="#">Something else here</a></li> */}
                                <li><hr className="dropdown-divider" /></li>
                                <li><a className="dropdown-item" onClick={handleLogout}>Log out</a></li>
                            </ul>
                        </div>) : (<a className="btn btn-secondary" href="/login" role="button">Log in</a>)}
                    </div>
                </div>
            </nav>
        </div>
