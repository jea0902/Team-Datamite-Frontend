...
function Login() {
    ...
    return (
        <div className="container-sm">
            ...
            <div className="card text-center mb-3 mx-auto align-items-center" style={{width:"30rem"}}>
                <div className="card-body w-100">
                    ...
                    <form onSubmit={onSubmit}>
                        <div className="mb-3 text-start">
                            ...
                            />
                            {idError && <div style={{ color: 'red', fontSize: '12px', marginTop: '5px', paddingLeft: '3px' }}>{idError}</div>}
                        </div>
                        <div className="mb-3 text-start">
                            <input
                            ...
                            />
                            {pwError && <div style={{ color: 'red', fontSize: '12px', marginTop: '5px', paddingLeft: '3px' }}>{pwError}</div>}
                        </div>
                    ...
                    <div className="p-2 mx-auto"><a className="link-secondary link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/find-id">아이디 찾기</a></div>
                        <div className="vr mt-2 mb-2"></div>
                        <div className="p-2 mx-auto"><a className="link-secondary link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/find-password">비밀번호 재설정</a></div>
                        <div className="vr mt-2 mb-2"></div>
                        <div className="p-2 mx-auto"><a className="link-secondary link-offset-3-hover link-underline-light link-underline-opacity-0 link-underline-opacity-75-hover" href="/signup">회원가입</a></div>
