...
function Myinfo() {
    ...
    async function withdrawal() {
        ...
        if (shouldDeleteAccount) {
            ...
            try {
                const result = await axios.delete('http://localhost:8080/api/members/delete/account',
                    {
                        headers: {
                            Authorization: accessToken,
                            "Content-Type": "application/json",
        ...
        <div>
            ...
            <form className="mt-2">
                <div className="row mb-3">
                    ...
                    <label htmlFor="id" className="col-sm-10 col-form-label">{userData.memberId}</label>
                </div>
                <div className="row mb-3">
                    <label htmlFor="name" className="col-sm-2 col-form-label">이름</label>
                    <label htmlFor="name" className="col-sm-10 col-form-label">{userData.name}</label>
                </div>
                <div className="row mb-3">
                    <label htmlFor="birthdate" className="col-sm-2 col-form-label">생년월일</label>
                    <label htmlFor="birthdate" className="col-sm-10 col-form-label">{userData.birthDate.split('-').join('')}</label>
                </div>
                <div className="row mb-3">
                    <label htmlFor="gender" className="col-sm-2 col-form-label">성별</label>
                    <label htmlFor="gemder" className="col-sm-10 col-form-label">{userData.gender}</label>
                </div>
                <div className="row mb-3">
                    <label htmlFor="email" className="col-sm-2 col-form-label">이메일</label>
                    <label htmlFor="email" className="col-sm-10 col-form-label">{userData.email}</label>
                </div>
                <hr />
                ...
                <form id="updateInfoForm" onSubmit={onSubmit}>
                    ...
                    <Modal.Body>
                        ...
                        <div className="row mb-3">
                            ...
                            <label htmlFor="id" className="col-sm-8 col-form-label">{userData.memberId}</label>
                        </div>
                        {/* 비밀번호 */}
                        <div className="row mb-3">
                        ...
                        <div className="row mb-3">
                            ...
                            <label htmlFor="name" className="col-sm-8 col-form-label">{userData.name}</label>
                        </div>
                        {/* 생년월일 */}
                        <div className="row mb-3">
